...
# Cell
def read_model_parameters(ClockStruct,Soil,Crop,planting_dates,harvest_dates):
    """
...
def compute_variables(ParamStruct,weather_df,ClockStruct,acfp=pathlib.Path(os.path.abspath(aquacrop.__file__)).parent):
    ...
    *Returns:*
    ...
    for i in range(ParamStruct.NCrops):
        ...
        # Crop calander
        crop = compute_crop_calander(crop,ParamStruct,ClockStruct,weather_df)
...
# Cell
def compute_crop_calander(crop,ParamStruct,ClockStruct,weather_df):
    """
...
#             assert idx > -1
            ...
            date_range = pd.date_range(ClockStruct.PlantingDates[0],ClockStruct.TimeSpan[-1])
